...
<div class="max-w-2xl mx-auto">
    <div class="bg-white p-10 rounded-3xl shadow-soft border border-stone-100">
        ...
        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                <label class="block text-sm font-bold text-stone-700 mb-2">Аватар</label>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-bold text-stone-700 mb-1">Имя</label>
            ...
            <div>
                <label class="block text-sm font-bold text-stone-700 mb-1">О себе</label>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-bold text-stone-700 mb-1">Повтор нового</label>
